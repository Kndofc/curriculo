    ...
    <section id="home">
      <div class="home">
        ...
        <div class="max-width">
          ...
          <div class="texto2"><span>Kauan</span></div>
          <div class="texto3">
            &nbsp;{text}
          </div>
          <a href="https://www.linkedin.com/in/kauan-lopes-919b861bb/" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Encontre-me</a>
        </div>
        <div class="right-img">
