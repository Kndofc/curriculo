        ...
        <section class="page-section" id="contact">
            ...
            <div class="container-contact">
                <div class="ways-contact">
                    ...
                    <p>Caso queira entrar em contato comigo me mande uma mensagem e se não conseguir por aqui tem minhas redes sociais e até mesmo o Whatsapp ali embaixo, eu irei adorar.</p>
                    <ul class="list-icons">
                        <li>
                            <i class="fa fa-envelope" id="icon-contact"></i> 
                            <a href="mailto:kauan.lopess@outlook.com"><p>kauan.lopess@outlook.com</p></a>
                        </li>
                        <li>
                            <i class="fa fa-location-dot" id="icon-contact"></i>
                            <p class="mg-icon-2">São Paulo - Brasil</p>
                        </li>
                    </ul>
                </div>
                <form action="https://formsubmit.co/fecfce57d3e403900dad1688f2d9c317" method="POST" class="form-contact">
                    <input type="hidden" name="_next" value="kauan.lopess@outlook.com" />
